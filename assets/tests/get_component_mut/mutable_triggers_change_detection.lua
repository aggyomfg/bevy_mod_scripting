...
local comp_read = world.get_component(entity, TestComponent)
...
print("Initial changed tick: " .. tostring(tick_before_val))

-- Now access the component with mutable access (this should update the changed tick)
local comp_mut = world.get_component(entity, TestComponent)
